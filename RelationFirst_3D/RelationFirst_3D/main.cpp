...
//    FILE* fp1 = NULL;
//    fp1 = fopen("/Users/hanzhekaiscomputer/Desktop/P1000-.txt", "r"); // 修改文件名
//
//    int x, y;
//    float d;
...
//    ofstream white;
//    white.open("/Users/hanzhekaiscomputer/Desktop/output_for_relation_P1000.txt");    // output文件
//    for (int i = 0; i < VERTEX_NUM; i++) {
...
void read_file(float** distance) {
    FILE* fp1 = NULL;
    fp1 = fopen("/Users/hanzhekaiscomputer/Desktop/P70-1000.txt", "r"); // 修改文件名
...
float evaluate(float** position, float** distance) {
    ...
    return total_error / VERTEX_NUM;
}

//输出
void output(float** position) {
    ofstream white;
    white.open("/Users/hanzhekaiscomputer/Desktop/P61-1000-output.txt");    // output文件
    for (int i = 0; i < VERTEX_NUM; i++) {
        white << std::fixed << position[i][0] << " " << position[i][1] << " " << position[i][2] << endl;
    }
}
...
//    int vertex_relevance[VERTEX_NUM];
    ...
    float error_rate = evaluate(p2position, p2distance);
    cout << "Total_error/vertex_num: " << error_rate << endl;
